...
public class AutoReservierenView extends VerticalLayout implements View {
    ...
    public void setUp(){
        ...
        List<FahrzeugDTO> liste = ContainerFahrzeugDAO.getInstance().getFahrzeugByKundenummer(kundeNummer);
        grid.setItems(liste);
        grid.setCaption("Meine Reservierungsliste " + liste.size());
